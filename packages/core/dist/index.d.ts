 ...
 */
declare const SLAB_TIERS_V12_15: Record<string, {
    maxAccounts: number;
    dataSize: number;
    label: string;
    description: string;
...
type ReserveCohortBytes = Uint8Array;
interface Account {
    kind: AccountKind;
    accountId: bigint;
    capital: bigint;
